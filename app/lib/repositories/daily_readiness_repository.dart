...
class DailyReadinessRepository {
  ...
  Future<bool> saveDailyReadiness(DailyReadiness readiness) async {
    try {
      ...
      developer.log('Error saving daily readiness: $e', name: 'DailyReadinessRepository');
      return false;
    }
  }
  ...
  Future<List<DailyReadiness>> getReadinessHistory(
    ...
    try {
      ...
      developer.log('Error getting readiness history: $e', name: 'DailyReadinessRepository');
      return [];
    }
  }
}
